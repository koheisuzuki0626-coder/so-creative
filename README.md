...
```
料金 = 基本料金 ¥90,000 ＋ 秒単価 × 合計秒数 ＋ ¥65,000 × (本数 − 1) ＋ 人物ナレーション
工数 =        3.0h      ＋ 0.15h × 倍率 × 合計秒数 ＋ 1.5h × (本数 − 1) ＋ 1.0h × ナレーション本数

人物ナレーション ／ ¥70,000〜 × 1名（本数では増えない）。**AIナレーションは料金に含む**
```
...
|----|-------:|----------|--------------|-----:|----------------|
| 梅 標準 | ¥3,500 | なし（設備・製品中心） | **AIは込み**／人物 1名 ¥70,000〜 | 2回 | SNS投稿・社内共有 |
| 竹 上 | ¥4,900 | **2人まで** | **AIは込み**／人物 1名 ¥70,000〜 | 3回 | 採用サイト・会社紹介 |
...
| ナレーションを足しても全体の時間単価が目標を割らない | 人物の ¥70,000 は外注費を含むので「÷1.0h」を単価として使わない。AI・人物それぞれの下限で見る。**AIは無料なので下限がここに出る（¥22,800）。**納期も +1週以内 |
...
段が上がっても時間単価は下がらない。
全238通り（段×尺×本数×ナレーション3択）をクリックして検証しており、**¥22,800〜34,618/h** に収まる。
